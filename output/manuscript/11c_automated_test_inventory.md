...
Two different counts matter and must not be conflated. The suite *collects* 1813 tests in 91 files across 11 source subpackages; a collection count alone certifies nothing. A passing run is certified only by the source-bound quality receipt, which records 1813 passed, 0 failed, and 0 skipped tests with 6647 of 7114 statements covered (91.88% combined). The receipt binds that evidence to source fingerprint 4ebe6ac79f83 and was recorded at 2026-09-14T19:06:31.854086+00:00; a receipt whose fingerprint no longer matches the tree is rejected. The metrics writer records installed NumPy 2.4.4 and DisCoPy 1.2.2.
