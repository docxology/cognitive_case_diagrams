...
\begin{frame}{Case as Relational Algebra: From Surface Inflection to
...
\begin{frame}[fragile]{Why Diagrams Earn Free Rides: Spatial Constraints
as Inferential Engines}
...
{[}@friston2017active{]}. The intellectual lineage traces through
...
\begin{frame}{Five Converging Linguistic and Mathematical Traditions}
\protect\phantomsection\label{five-converging-linguistic-and-mathematical-traditions}
...
{[}@lorenz2023lambeq; @quantinuum2025genii{]} extend this to discourse
...
\begin{frame}{Active Inference Closes the Loop}
\protect\phantomsection\label{active-inference-closes-the-loop}
...
\begin{frame}{Roadmap: Navigating the Eleven Principal Contributions}
