...
\begin{frame}{Multi-Agent Communication: Compositional AI Protocols}
\protect\phantomsection\label{multi-agent-communication-compositional-ai-protocols}
...
transformer architecture {[}@vaswani2017attention{]} is, at its
...
tradition {[}@firth1957papers{]}) and composes them into contextual
...
BERT {[}@devlin2019bert{]} and GPT {[}@radford2018improving{]} thus
...
{[}@akgul2026distributional{]} extends this parallel into the domain of
