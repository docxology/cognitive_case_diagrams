...
Two different counts matter and must not be conflated. The suite *collects* 1883 tests in 94 files across 12 source subpackages; a collection count alone certifies nothing. A passing run is certified only by the source-bound quality receipt, which records 1883 passed, 0 failed, and 0 skipped tests with 6976 of 7450 statements covered (92.13% combined). The receipt binds that evidence to source fingerprint ddb0e63ceb18 and was recorded at 2026-09-15T17:41:34.730254+00:00; a receipt whose fingerprint no longer matches the tree is rejected. The metrics writer records installed NumPy 2.4.4 and DisCoPy 1.2.2.
...
All canonical numerical examples are synthetic. Seeds or fixed arrays are declared in source. The project has no corpus split, participant sample, EEG dataset, quantum-hardware receipt, or operational-agent security evaluation. This revision is identified by [10.5281/zenodo.22774403](https://zenodo.org/records/22774403); the series uses DOI 10.5281/zenodo.19695259. The live deposit state is reported at the version-record link.
