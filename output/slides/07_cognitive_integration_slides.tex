...
\begin{frame}{Static Categories Are Not Enough}
...
Active inference {[}@friston2017active{]} provides exactly this missing
dynamic computational layer.
\end{frame}

\begin{frame}[fragile]{Surprise Minimization as Case Parsing}
\protect\phantomsection\label{surprise-minimization-as-case-parsing}
...
\begin{block}{Five-Step Generative Loop}
\protect\phantomsection\label{five-step-generative-loop}
