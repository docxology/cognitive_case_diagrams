...
Two different counts matter and must not be conflated. The suite *collects* 1783 tests in 91 files across 11 source subpackages; a collection count alone certifies nothing. A passing run is certified only by the source-bound quality receipt, which records 1783 passed, 0 failed, and 0 skipped tests with 6599 of 7081 statements covered (91.52% combined). The receipt binds that evidence to source fingerprint bac101a70d09 and was recorded at 2026-09-08T19:19:32.967234+00:00; a receipt whose fingerprint no longer matches the tree is rejected. The metrics writer records installed NumPy 2.4.4 and DisCoPy 1.2.2.
