...
\begin{frame}{The Inter-Theoretic Translation Problem}
...
\begin{frame}{Classifying Toposes: The Logical Shape of a Theory}
\protect\phantomsection\label{classifying-toposes-the-logical-shape-of-a-theory}
\begin{block}{A Topos Is a Universe With Internal Logic}
\protect\phantomsection\label{a-topos-is-a-universe-with-internal-logic}
...
\begin{frame}[fragile]{A Chain of Morita Equivalences Connects Case
Theories}
\protect\phantomsection\label{a-chain-of-morita-equivalences-connects-case-theories}
...
\begin{frame}{Phillips: LoT Properties Arise as Universal Topos
Constructions}
\protect\phantomsection\label{phillips-lot-properties-arise-as-universal-topos-constructions}
...
\begin{frame}{Caramello's Learning Algorithm}
\protect\phantomsection\label{caramellos-learning-algorithm}
...
\begin{frame}{Morita Equivalence Diagrams Are Themselves Free-Ride
Inferences}
...
build\_typological\_theory(), check\_morita\_equivalence(),
bridge\_transfer()---All Working}
\protect\phantomsection\label{python-implementation-build_typological_theory-check_morita_equivalence-bridge_transferall-working}
...
\begin{block}{Classifying Toposes: The Logical Shape of a Theory}
\protect\phantomsection\label{classifying-toposes-the-logical-shape-of-a-theory-1}
