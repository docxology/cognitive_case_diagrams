...
\begin{frame}[fragile]{Appendix A: Syntactic and Semantic Case
Assignment Diagrams}
\protect\phantomsection\label{sec:syntactic-diagrams}
...
\begin{block}{Syntactic Trees and Pregroup Types: Eight Constructions}
