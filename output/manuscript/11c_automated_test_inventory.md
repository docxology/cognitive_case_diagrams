...
Two different counts matter and must not be conflated. The suite *collects* 1837 tests in 91 files across 11 source subpackages; a collection count alone certifies nothing. A passing run is certified only by the source-bound quality receipt, which records 1837 passed, 0 failed, and 0 skipped tests with 6722 of 7191 statements covered (91.94% combined). The receipt binds that evidence to source fingerprint e97d40741270 and was recorded at 2026-09-15T02:20:12.609861+00:00; a receipt whose fingerprint no longer matches the tree is rejected. The metrics writer records installed NumPy 2.4.4 and DisCoPy 1.2.2.
...
All canonical numerical examples are synthetic. Seeds or fixed arrays are declared in source. The project has no corpus split, participant sample, EEG dataset, quantum-hardware receipt, or operational-agent security evaluation. This revision is identified by [10.5281/zenodo.22758214](https://zenodo.org/records/22758214); the series uses DOI 10.5281/zenodo.19695259. The live deposit state is reported at the version-record link.
