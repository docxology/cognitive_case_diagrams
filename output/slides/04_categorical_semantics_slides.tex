...
\begin{frame}{The Formalism--Distribution Impasse and Why Montague
Cannot Meet Harris}
...
{[}-@turney2010frequency{]} comprehensive survey of vector space models
proved that distributional methods smoothly capture highly fine-grained
semantic distinctions---synonymy, antonymy, hypernymy, analogy---but
strictly isolate these victories to the isolated word level. Baroni and
Lenci {[}-@baroni2010distributional{]} built a tensor-based
...
thoroughly surveyed this modern landscape and formally identified the
central open problem: discovering exactly how to fuse the
\emph{algebraic compositionality} of formal semantics with the powerful
...
\begin{frame}{Word2Vec → BERT → GPT}
\protect\phantomsection\label{word2vec-bert-gpt}
...
\item
  ...
  {[}@vaswani2017attention{]} explicitly implements distributional
...
\begin{frame}{The Meaning Functor
...
\begin{frame}{Case-Typed Noun Spaces and Alignment as Natural
Transformation}
...
{[}-@shimojima1996reasoning{]} free-ride inference: the diagram
