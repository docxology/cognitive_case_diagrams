...
Prompt injection and frame manipulation as decidable type violations against a finite case category (and optional enriched structure). Framed as a **protocol-level** analysis in [`09b_cognitive_security.md`](../../docs/manuscript/09b_cognitive_security.md), not a guarantee on production LLM APIs.
