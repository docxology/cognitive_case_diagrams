...
\begin{frame}{Quantum Active Inference: Topological Semantic
Communication}
...
\begin{block}{Topological Quantum Neural Networks: Spin-Network
Representations}
\protect\phantomsection\label{topological-quantum-neural-networks-spin-network-representations}
...
\begin{block}{TQNN-DisCoCat Alignment: Ribbon and Tensor Diagrams}
\protect\phantomsection\label{tqnn-discocat-alignment-ribbon-and-tensor-diagrams}
...
\begin{block}{Distributional Semantics: Topological Quantum Flow}
\protect\phantomsection\label{distributional-semantics-topological-quantum-flow}
...
\begin{block}{Semantic Transfer: Sheaf-Theoretic Functorial Flow}
\protect\phantomsection\label{semantic-transfer-sheaf-theoretic-functorial-flow}
...
\begin{block}{Case Assignment: Active Inference and Quantum Measurement}
\protect\phantomsection\label{case-assignment-active-inference-and-quantum-measurement}
...
Sherborne et al. {[}-@sherborne2025paramqnlp{]} demonstrates this
