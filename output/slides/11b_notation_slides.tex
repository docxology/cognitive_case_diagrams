...
\begin{frame}[fragile]{Appendix B: Notation Reference}
...
\begin{block}{A. Linguistic Terms}
\protect\phantomsection\label{a.-linguistic-terms}
...
\begin{block}{B. Category Theory}
\protect\phantomsection\label{b.-category-theory}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2222}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2778}}
...
\begin{block}{C. Enriched Categories and Magnitude}
\protect\phantomsection\label{c.-enriched-categories-and-magnitude}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2222}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2778}}
...
\begin{block}{D. Distributional Semantics and LLMs}
\protect\phantomsection\label{d.-distributional-semantics-and-llms}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2222}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2778}}
...
\begin{block}{E. Distributional Active Inference (DAIF)}
\protect\phantomsection\label{e.-distributional-active-inference-daif}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2222}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2778}}
...
\begin{block}{F. Active Inference and Cognitive Models}
\protect\phantomsection\label{f.-active-inference-and-cognitive-models}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2222}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2778}}
...
\begin{block}{G. Quantum and Topological Terms}
\protect\phantomsection\label{g.-quantum-and-topological-terms}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2222}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2778}}
...
\begin{block}{H. Logical and Type-Theoretic Terms}
\protect\phantomsection\label{h.-logical-and-type-theoretic-terms}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2222}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2778}}
...
\begin{block}{I. AI and Communication Protocols}
\protect\phantomsection\label{i.-ai-and-communication-protocols}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2222}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2778}}
...
\begin{block}{J. Diagrammatic Reasoning}
\protect\phantomsection\label{j.-diagrammatic-reasoning}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2222}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2778}}
...
\begin{block}{K. Notation Conventions}
\protect\phantomsection\label{k.-notation-conventions}
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}
