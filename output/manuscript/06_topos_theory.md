...
For the standard 8-case category, this yields a theory with 8 sorts and 8 relation symbols. The minimal 3-case category produces a theory with 3 sorts and 3 relation symbols. Our `build_enriched_theory()` function further annotates the geometric theory with $[0,1]$-valued hom weights from the enriched structure of \autoref{sec:enriched-categories}.
