...
\begin{frame}[fragile]{Eight Case Roles as Objects}
...
satisfaction per Dowty's {[}-@dowty1991thematic{]} decomposition. The
enriched structure over \(([0,1], \cdot, 1)\) ensures multiplicative
...
\begin{frame}[fragile]{Accusative vs.~Ergative as Structurally
...
\begin{frame}{Graded Proto-Roles as \([0,1]\)-Weighted Morphisms}
...
\begin{frame}[fragile]{Alignment Shifts as Natural Transformations:
Grammar Agreement as Functor Commutativity}
\protect\phantomsection\label{alignment-shifts-as-natural-transformations-grammar-agreement-as-functor-commutativity}
